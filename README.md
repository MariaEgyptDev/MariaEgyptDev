...
<img src="https://i.ibb.co/5hTZ6BmC/female-coding.gif" width="40%" alt="Coding Girl"/>

# 👩‍💻 Maria Adel | ماريا عادل

**Student • Growing Programmer • Aspiring Developer**

I’m a 16-year-old student passionate about programming and learning new technologies.  
This GitHub profile is where I document my learning journey, experiments, and small projects.

I focus on building strong basics, practicing consistently, and improving step by step.  
My dream is to travel, grow as a developer, and build a future I’m proud of. 🌍✨
...
- Studying HTML & CSS for web basics  
- Building small projects to apply what I learn  
- Sharing my progress openly on GitHub  

---

## 🎯 Goals
- Strengthen my programming fundamentals  
- Build clean, simple, and useful projects  
- Improve logic and confidence step by step  
- Grow into an independent and skilled developer  

---

## ✨ Coding Mood ✨
<div align="center">
<img src="https://i.ibb.co/2s1fG3H/female-coding.gif" width="20%" alt="Coding"/>
